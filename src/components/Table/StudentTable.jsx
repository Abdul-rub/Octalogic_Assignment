import { additionalStudentData } from "../../db.json"
...
export const StudentTable = ({ stdshow }) => {
  const EntriesToShow = stdshow ? additionalStudentData.length : 5;
        ...
        <div className='inline-block min-w-full py-2 sm:px-6 lg:px-8'>
          <div className='overflow-hidden'>
            <table className='min-w-full h-auto text-left text-sm font-light'>
              ...
              <tbody>
                {additionalStudentData.slice(0, EntriesToShow).map((el, i) => (
